...
seed = 2346710569210323
prompt = "cinematic film still, of an anthropomorphic capybara, ral-dissolve"
height = 1024
width = 1024
...
lora_node.set_adapters(["ral-dissolve"], [1.5])
...
### SAVE IMAGE
images_output.images[0].save("outputs/t2i_lora.png")
